 ...
 <div class="span10">
     ...
     <div class="widget paddi">
       ...
       <div class="widget-content padd">
         ...
         <h2 class="colores"> <i class="icon-user"></i> Detalle Datos Jefe de Grupo</h2>
      ...
      <div class="widget-content medida">
        <h3 class="colores"> <i class="icon-list"></i> Información Adicional</h3>
         ...
         <label for="fech_eleccion" class="tamletra2">Fecha Elección</label>
                  <input type="text" id="fech_eleccion"  onkeyup="this.value=soloNumeros(this.value)" disabled minlength="10" maxlength="10" class="form-control monte11" placeholder="1717171717" required="required" autofocus="autofocus">      
        </div> <!-- /widget-content -->
           </div> <!-- /widget -->
         </div> <!-- /span4 -->
