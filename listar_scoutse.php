 ...
 <div class="span10">     
     <div class="widget paddi">       
       <div class="widget-content padd">       
         <h2 class="colores"> <i class="icon-list"></i> Listar Scout</h2>         
          <hr>
...
<div class="widget">	      			
 ...
 <div class="span1 hespan">	      		
     <div class="widget">	      			
      ...
      <button type="button" class="btn btn-primary btn-block coloricono" onclick="showListadoScoutssc(this.value)"><i class="icon-search icon-2x"></i></button>
 </div>  
     </div>  
 </div> <!-- /span4 -->
