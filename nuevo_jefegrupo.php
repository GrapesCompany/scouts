 ...
 <div class="span10">
     ...
     <div class="widget paddi">
       ...
       <div class="widget-content padd">
         ...
         <h2 class="colores"> <i class="icon-user"></i> Nuevo Jefe de Grupo</h2>
...
<div class="span4 hespan">	      		
 ...
 <div class="span4 hespan">	      		
    ...
    <label for="edad" class="tamletra">Edad</label>
            <input type="text" id="edad" name="edad" nkeyup="this.value=soloNumeros(this.value)" maxlength="2" class="form-control monte" placeholder="18" required="required">
 </div> <!-- /widget-content -->
     </div> <!-- /widget -->
 </div> <!-- /span4 -->
