...
<div class="span4 hespan">	      		
     ...
     <input type="text" name="cedula" id="cedula"  onkeyup="this.value=soloNumeros(this.value)" disabled minlength="10" maxlength="10" class="form-control monte10" placeholder="1717171717" required="required" autofocus="autofocus">
           </div> <!-- /widget-content -->
     </div> <!-- /widget -->
   </div> <!-- /span4 -->
...
<div class="span4 hespan">	      		
 ...
 <div class="widget">	      			
   ...
   <input type="text" id="genero" name="genero"  class="form-control monte10" disabled placeholder="genero" required="required">
...
<label for="edad" class="tamletra2">Edad</label>
 ...
 <div class="span4 hespan">	      		
   ...
   <label for="telefono" class="tamletra2">Teléfono</label>
            <input type="text" id="telefono" name="telefono" disabled  onkeyup="this.value=soloNumeros(this.value)" maxlength="10" class="form-control monte10" placeholder="Teléfono" required="required" autofocus="autofocus">
 </div> <!-- /widget-content -->
     </div> <!-- /widget -->
 </div> <!-- /span4 -->
 ...
 <div class="span4 hespan">	      		
     <div class="widget">	      			
       ...
       <input type="text" id="direccion" name="direccion" class="form-control monte10" disabled placeholder="Dirección" required="required">
   </div> <!-- /widget-content -->
     </div> <!-- /widget -->
 </div> <!-- /span4 -->
...
<div class="widget">	      			
 ...
 <input type="text" id="unidad" name="unidad" disabled class="form-control monte10" placeholder="Fecha de Nacimiento" required="required">
...
<label for="uespecifica" class="tamletra2">Unidad específica</label>
      <input type="text" id="uespecifica" class="form-control monte10" disabled placeholder="Unidad específica" required="required" autofocus="autofocus">
 ...
 <div class="container">	    	  
  <div class="span10"> 
     <div class="widget medida2">
       <div class="widget-content medida">
         <h3 class="colores"> <i class="icon-user"></i> Representante</h3>
          ...
          <label for="cedular" class="tamletra2">Cédula</label>
                   <input type="text" id="cedular"  onkeyup="this.value=soloNumeros(this.value)" disabled minlength="10" maxlength="10" class="form-control monte11" placeholder="1717171717" required="required" autofocus="autofocus">      
         </div> <!-- /widget-content -->
            </div> <!-- /widget -->
          </div> <!-- /span4 -->
          ...
          <label for="nombrer" class="tamletra2">Nombres Completos</label>
                   <input type="text" id="nombrer" onkeyup="this.value=soloLetras(this.value)" disabled class="form-control monte11" placeholder="Example" required="required" autofocus="autofocus">      
         </div> <!-- /widget-content -->
            </div> <!-- /widget -->
          </div> <!-- /span4 -->
        ...
        <label for="direccionr" class="tamletra2">Dirección</label>
                 <input type="text" id="direccionr" class="form-control monte11" disabled placeholder="Riobamba" required="required" autofocus="autofocus">      
       </div> <!-- /widget-content -->
          </div> <!-- /widget -->
        </div> <!-- /span4 -->
      ...
      <label for="telefonor" class="tamletra2">Telefóno</label>
               <input type="text" id="telefonor" onkeyup="this.value=soloNumeros(this.value)" disabled maxlength="10"  class="form-control monte11" placeholder="0999988888" required="required" autofocus="autofocus">      
     </div> <!-- /widget-content -->
        </div> <!-- /widget -->
      </div> <!-- /span4 -->
            </div>
  ...
  <div class="widget">	      			
    <div class="widget-content colorwidget">
    <br>
    <button type="button" class="btn btn-warning colorbtnlist" onclick="showListadoJefegc()">Regresar</button>
</div> <!-- /widget-content -->
  </div> <!-- /widget -->
</div> <!-- /span4 -->
